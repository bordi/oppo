...
function doFilter(b) {
    ...
    if (cache[h]){
        ...
        $(".product-" + view).append('<div class="ajax-loader" id="ajax-loader"></div>');
        $(".product-" + view).css('opacity','0.2');
        ...
        $.ajax({url:"index.php?route=module/filterpro/getproducts", type:"POST", data:a + (b ? "&getPriceLimits=true" : ""), dataType:"json", success:function (g) {
            success(g, b);
            cache[h] = g;
            $(".product-" + view).remove('#ajax-loader');
            $(".product-" + view).css('opacity','1');
        }});
    }
}
$(document).ready(function () {
    ...
    $(".option_box label").live('click touchstart',function () {
