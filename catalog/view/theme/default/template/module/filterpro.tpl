...
<script id="productTemplate" type="text/x-jquery-tmpl">
		<article class="product__box">
			{{if thumb}}
			<div class="image">
				<a href="${href}" class="main__image">
					<img src="${thumb}" title="${name}" alt="${name}" data-rel="${thumbs}"   data-count="0" class="product__image"/>
				</a>
			...
			{{/if}}
			<div class="cart">
				<a onclick="addToCart('${product_id}');" class="button btn-cart small-btn"><span><?php echo $button_cart; ?></span></a>
