      ...
      <table class="form">
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($payment == 'webmoney') { ?>
              <input type="radio" name="payment" value="webmoney" id="webmoney" checked="checked" />
              <?php } else { ?>
              <input type="radio" name="payment" value="webmoney" id="webmoney" />
              <?php } ?>
              <label for="webmoney"><?php echo $text_webmoney; ?></label>
			  <?php if ($payment == 'yandex_money') { ?>
              <input type="radio" name="payment" value="yandex_money" id="yandex_money" checked="checked" />
              <?php } else { ?>
              <input type="radio" name="payment" value="yandex_money" id="yandex_money" />
              <?php } ?>
              <label for="yandex_money"><?php echo $text_yandex_money; ?></label>
		...
		<tbody id="payment-webmoney" class="payment">
          <tr>
            <td><?php echo $entry_webmoney_wmr; ?></td>
            <td><input type="text" name="webmoney_wmr" value="<?php echo $webmoney_wmr; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_webmoney_wmz; ?></td>
            <td><input type="text" name="webmoney_wmz" value="<?php echo $webmoney_wmz; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_webmoney_wme; ?></td>
            <td><input type="text" name="webmoney_wme" value="<?php echo $webmoney_wme; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_webmoney_wmu; ?></td>
            <td><input type="text" name="webmoney_wmu" value="<?php echo $webmoney_wmu; ?>" /></td>
          </tr>
		  <tr>
            <td><?php echo $entry_marker; ?></td>
            <td><?php echo $text_marker; ?></td>
          </tr>
        </tbody>
		<tbody id="payment-yandex_money" class="payment">
          <tr>
            <td><?php echo $entry_yandex_money; ?></td>
            <td><input type="text" name="yandex_money" value="<?php echo $yandex_money; ?>" /></td>
          </tr>
        </tbody>
