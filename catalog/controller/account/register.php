...
class ControllerAccountRegister extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		$this->data['text_note_groups'] = $this->language->get('text_note_groups');
		$this->data['text_note_email'] = $this->language->get('text_note_email');
		$this->data['text_note_telephone'] = $this->language->get('text_note_telephone');
		$this->data['text_note_fax'] = $this->language->get('text_note_fax');
		$this->data['text_note_company'] = $this->language->get('text_note_company');
		$this->data['text_note_company_id'] = $this->language->get('text_note_company_id');
		$this->data['text_note_tax_id'] = $this->language->get('text_note_tax_id');
		$this->data['text_note_address_1'] = $this->language->get('text_note_address_1');
		$this->data['text_note_address_2'] = $this->language->get('text_note_address_2');
		$this->data['text_note_city'] = $this->language->get('text_note_city');
		$this->data['text_note_postcode'] = $this->language->get('text_note_postcode');
