	...
	public function index() { 
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				...
				$this->data['thumb0'] = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_width'));
			} else {
				$this->data['thumb'] = '';
			}
