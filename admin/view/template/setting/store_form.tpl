        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td width="250"><input type="text" name="config_fax" value="<?php echo $config_fax; ?>" /></td>
			  <td></td>
            </tr>
          </table>
        </div>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><select name="config_customer_group_id">
        ...
        <div id="tab-server">
          <table class="form">
            <tr>
              ...
              <td width="150"><?php if ($config_use_ssl) { ?>
