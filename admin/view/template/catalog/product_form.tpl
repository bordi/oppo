...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><!-- webme - additional fields - part_#1 - start //--><a tab="#tab_waf"><?php echo $tab_waf; ?></a><!-- webme - additional fields - part_#1  - end //--><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
            ...
            <table class="form">
              ...
              <tr>
	            ...
	            <tr>
		            ...
		            <td><textarea name="product_description[<?php echo $language['language_id']; ?>][short_description]" cols="100" rows="2"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea></td>
	            </tr>
              <tr>
        ...
        <div id="tab-reward">
          <table class="form">
            <tr>
              ...
              <td width="1"><input type="text" name="points" value="<?php echo $points; ?>" /></td>
			  <td><?php echo $info_points; ?></td>
            </tr>
          </table>
          <table class="list">
            <thead>
