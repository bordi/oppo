          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($manufacturer['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="center"><img src="<?php echo $manufacturer['image']; ?>" alt="<?php echo $manufacturer['name']; ?>" title="<?php echo $manufacturer['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
