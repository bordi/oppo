...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="special_module[' + module_row + '][limit]" value="6" size="1" /></td>';
	html += '    <td class="left"><input type="text" name="special_module[' + module_row + '][image_width]" value="130" size="3" /> <input type="text" name="special_module[' + module_row + '][image_height]" value="130" size="3" /></td>';	
