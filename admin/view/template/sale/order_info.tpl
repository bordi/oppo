      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $customer; ?>"><?php echo $firstname; ?> <?php echo $lastname; ?></a> [ <a href="<?php echo $find_other_orders_href; ?>"><?php echo $text_find_other_orders; ?></a> ]</td>
          </tr>
          <?php } else { ?>
          <tr>
            <td><?php echo $text_customer; ?></td>
            <td><?php echo $firstname; ?> <?php echo $lastname; ?></td> [ <a href="<?php echo $find_other_orders_href; ?>"><?php echo $text_find_other_orders; ?></a> ]</td>
          </tr>
          <?php } ?>
      ...
      <div id="tab-product" class="vtabs-content">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  <td class="left"><img src="<?php echo HTTP_IMAGE.$productinfo->row['image']; ?>" width="120" /></td>
