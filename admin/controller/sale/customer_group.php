...
class ControllerSaleCustomerGroup extends Controller {
	...
	private function getForm() {
		...
		$this->data['text_basic_data'] = $this->language->get('text_basic_data');
		$this->data['text_address_display'] = $this->language->get('text_address_display');
		...
		$this->data['entry_telephone_display'] = $this->language->get('entry_telephone_display');
		$this->data['entry_fax_display'] = $this->language->get('entry_fax_display');
		$this->data['entry_address_display'] = $this->language->get('entry_address_display');
		$this->data['entry_company_display'] = $this->language->get('entry_company_display');
		$this->data['entry_address_2_display'] = $this->language->get('entry_address_2_display');
		$this->data['entry_additional_display'] = $this->language->get('entry_additional_display');
		...
		$this->data['info_approval'] = $this->language->get('info_approval');
		$this->data['info_telephone_display'] = $this->language->get('info_telephone_display');
		$this->data['info_fax_display'] = $this->language->get('info_fax_display');
		$this->data['info_address_display'] = $this->language->get('info_address_display');
		$this->data['info_company_display'] = $this->language->get('info_company_display');
		$this->data['info_address_2_display'] = $this->language->get('info_address_2_display');
		$this->data['info_additional_display'] = $this->language->get('info_additional_display');
		$this->data['info_company_id_display'] = $this->language->get('info_company_id_display');
		$this->data['info_company_id_required'] = $this->language->get('info_company_id_required');
		$this->data['info_tax_id_display'] = $this->language->get('info_tax_id_display');
		$this->data['info_tax_id_required'] = $this->language->get('info_tax_id_required');
		...
		if (isset($this->request->post['telephone_display'])) {
			$this->data['telephone_display'] = $this->request->post['telephone_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['telephone_display'] = $customer_group_info['telephone_display'];
		} else {
			$this->data['telephone_display'] = '';
		}	
		
		if (isset($this->request->post['fax_display'])) {
			$this->data['fax_display'] = $this->request->post['fax_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['fax_display'] = $customer_group_info['fax_display'];
		} else {
			$this->data['fax_display'] = '';
		}	
		
		if (isset($this->request->post['address_display'])) {
			$this->data['address_display'] = $this->request->post['address_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['address_display'] = $customer_group_info['address_display'];
		} else {
			$this->data['address_display'] = '';
		}
		...
		if (isset($this->request->post['additional_display'])) {
			$this->data['additional_display'] = $this->request->post['additional_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['additional_display'] = $customer_group_info['additional_display'];
		} else {
			$this->data['additional_display'] = '';
		}
		...
		if (isset($this->request->post['address_2_display'])) {
			$this->data['address_2_display'] = $this->request->post['address_2_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['address_2_display'] = $customer_group_info['address_2_display'];
		} else {
			$this->data['address_2_display'] = '';
		}	
