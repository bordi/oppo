...
class ControllerSaleCoupon extends Controller {
	private $error = array();
  	...
  	private function getForm() {
		...
		$this->data['info_code'] = $this->language->get('info_code');
		$this->data['info_type'] = $this->language->get('info_type');
		$this->data['info_total'] = $this->language->get('info_total');
		$this->data['info_logged'] = $this->language->get('info_logged');
		$this->data['info_category'] = $this->language->get('info_category');
		$this->data['info_product'] = $this->language->get('info_product');
		$this->data['info_uses_total'] = $this->language->get('info_uses_total');
		$this->data['info_uses_customer'] = $this->language->get('info_uses_customer');
