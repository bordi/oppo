...
class ControllerCatalogNews extends Controller {
	...
	private function getForm() {
		...
		$this->data['entry_main_ncategory'] = $this->language->get('entry_main_ncategory');
		...
		$this->data['info_acom'] = $this->language->get('info_acom');
		$this->data['info_main_ncategory'] = $this->language->get('info_main_ncategory');
	...
	if (isset($this->error['warning'])) {
		...
		if (isset($this->request->post['main_ncategory_id'])) {
			$this->data['main_ncategory_id'] = $this->request->post['main_ncategory_id'];
		} elseif (isset($news_info)) {
			$this->data['main_ncategory_id'] = $this->model_catalog_news->getNewsMainNcategoryId($this->request->get['news_id']);
		} else {
			$this->data['main_ncategory_id'] = 0;
		}
	...
	public function ncategory() {
		...
		if (isset($this->request->get['ncategory_id'])) {
			$ncategory_id = $this->request->get['ncategory_id'];
		} else {
			$ncategory_id = 0;
		}
		...
		$results = $this->model_catalog_news->getNewsByNcategoryId($ncategory_id);
		...
		$this->response->setOutput(json_encode($news_data));
	}
