...
class ControllerCatalogDownload extends Controller {  
	private $error = array();
  	...
  	private function getForm() {
		...
		$this->data['info_filename'] = $this->language->get('info_filename');
		$this->data['info_mask'] = $this->language->get('info_mask');
		$this->data['info_remaining'] = $this->language->get('info_remaining');
