...
class ModelSaleCustomerGroup extends Model {
	public function addCustomerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET approval = '" . (int)$data['approval'] . "', telephone_display = '" . (int)$data['telephone_display'] . "', fax_display = '" . (int)$data['fax_display'] . "', address_display = '" . (int)$data['address_display'] . "', company_display = '" . (int)$data['company_display'] . "', additional_display = '" . (int)$data['additional_display'] . "', company_id_display = '" . (int)$data['company_id_display'] . "', company_id_required = '" . (int)$data['company_id_required'] . "', tax_id_display = '" . (int)$data['tax_id_display'] . "', tax_id_required = '" . (int)$data['tax_id_required'] . "', address_2_display = '" . (int)$data['address_2_display'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
