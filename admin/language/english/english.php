...
// Info
$_['info_keyword']           = '<span class="help">Do not use spaces instead replace spaces with - and make sure the keyword is globally unique.</span>';
$_['info_image']             = '<span class="help">Click "Browse Files" to add an image, or "Clear Image" to clear the uploaded image.</span>';
