...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 01 2013 г., 22:54
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 33.14699936, 1, '2013-11-30 19:19:50'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2013-11-30 19:21:40'),
(3, 'Euro', 'EUR', '', '€', '2', 0.73589998, 1, '2013-11-30 19:19:50');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3420 ;
...
(3419, 0, 'config', 'config_google_analytics', '', 0),
...
(3418, 0, 'config', 'config_error_filename', 'error.txt', 0),
(3417, 0, 'config', 'config_error_log', '1', 0),
(3416, 0, 'config', 'config_error_display', '1', 0),
(53, 0, 'reward', 'reward_sort_order', '2', 0),
(54, 0, 'reward', 'reward_status', '1', 0),
(3415, 0, 'config', 'config_compression', '0', 0),
...
(3413, 0, 'config', 'config_seo_url_postfix', '', 0),
...
(3414, 0, 'config', 'config_encryption', '3892a7e8715a2557dfd848c5eadfa73a', 0),
(3412, 0, 'config', 'config_seo_url_include_path', '0', 0),
(3411, 0, 'config', 'config_seo_url_type', 'seo_url', 0),
(3410, 0, 'config', 'config_seo_url', '0', 0),
(3409, 0, 'config', 'config_maintenance', '0', 0),
(3408, 0, 'config', 'config_use_ssl', '0', 0),
(3407, 0, 'config', 'config_symbols_nsearch', '300', 0),
(3406, 0, 'config', 'config_symbols_ncategory', '300', 0),
(3405, 0, 'config', 'config_symbols_headlines', '400', 0),
(3404, 0, 'config', 'config_mod_news_side', '100', 0),
(3403, 0, 'config', 'config_mod_news', '370', 0),
(93, 0, 'voucher', 'voucher_sort_order', '8', 0),
(94, 0, 'voucher', 'voucher_status', '1', 0),
(3401, 0, 'config', 'config_bnews_thumb_height', '150', 0),
(3402, 0, 'config', 'config_bnews_order', '0', 0),
(3400, 0, 'config', 'config_bnews_thumb_width', '150', 0),
(102, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(3399, 0, 'config', 'config_bnews_image_height', '80', 0),
...
(3398, 0, 'config', 'config_bnews_image_width', '80', 0),
(3397, 0, 'config', 'config_image_ncategory_height', '80', 0),
(3396, 0, 'config', 'config_image_ncategory_width', '80', 0),
(3394, 0, 'config', 'config_sms_gate_username', '', 0),
(3395, 0, 'config', 'config_sms_gate_password', '', 0),
(3393, 0, 'config', 'config_sms_message', '', 0),
(3392, 0, 'config', 'config_sms_copy', '', 0),
(3391, 0, 'config', 'config_sms_to', '', 0),
(3390, 0, 'config', 'config_sms_from', '', 0),
(3389, 0, 'config', 'config_sms_gatename', 'smsc', 0),
(3388, 0, 'config', 'config_sms_alert', '0', 0),
(3387, 0, 'config', 'config_fraud_status_id', '14', 0),
...
(3386, 0, 'config', 'config_fraud_score', '', 0),
(3385, 0, 'config', 'config_fraud_key', '', 0),
(3384, 0, 'config', 'config_fraud_detection', '0', 0),
(3383, 0, 'config', 'config_alert_emails', '', 0),
(3382, 0, 'config', 'config_account_mail', '0', 0),
(3381, 0, 'config', 'config_alert_mail', '0', 0),
(3380, 0, 'config', 'config_smtp_timeout', '5', 0),
(3379, 0, 'config', 'config_smtp_port', '25', 0),
(3378, 0, 'config', 'config_smtp_password', '', 0),
(3376, 0, 'config', 'config_smtp_host', '', 0),
(3377, 0, 'config', 'config_smtp_username', '', 0),
(3375, 0, 'config', 'config_mail_parameter', '', 0),
(3374, 0, 'config', 'config_mail_protocol', 'mail', 0),
(3373, 0, 'config', 'config_image_cart_height', '225', 0),
(3372, 0, 'config', 'config_image_cart_width', '225', 0),
(3371, 0, 'config', 'config_image_wishlist_height', '47', 0),
(3369, 0, 'config', 'config_image_compare_height', '90', 0),
(3370, 0, 'config', 'config_image_wishlist_width', '47', 0),
(3368, 0, 'config', 'config_image_compare_width', '90', 0),
(3367, 0, 'config', 'config_image_related_height', '85', 0),
(3366, 0, 'config', 'config_image_related_width', '85', 0),
(3365, 0, 'config', 'config_image_additional_height', '85', 0),
(3364, 0, 'config', 'config_image_additional_width', '85', 0),
(3363, 0, 'config', 'config_image_product_height', '225', 0),
(3362, 0, 'config', 'config_image_product_width', '225', 0),
(3361, 0, 'config', 'config_image_popup_height', '700', 0),
(3360, 0, 'config', 'config_image_popup_width', '700', 0),
(3357, 0, 'config', 'config_image_category_height', '130', 0),
(3358, 0, 'config', 'config_image_thumb_width', '480', 0),
...
(3359, 0, 'config', 'config_image_thumb_height', '480', 0),
(3356, 0, 'config', 'config_image_category_width', '130', 0),
(3355, 0, 'config', 'config_icon', 'data/cart.png', 0),
(3354, 0, 'config', 'config_logo', 'data/logo.png', 0),
(3352, 0, 'config', 'config_commission', '5', 0),
(3353, 0, 'config', 'config_return_status_id', '2', 0),
(3351, 0, 'config', 'config_affiliate_id', '4', 0),
(3350, 0, 'config', 'config_stock_status_id', '5', 0),
(3349, 0, 'config', 'config_stock_checkout', '0', 0),
(3348, 0, 'config', 'config_stock_warning', '0', 0),
(3347, 0, 'config', 'config_stock_display', '0', 0),
(3346, 0, 'config', 'config_complete_status_id', '5', 0),
(3345, 0, 'config', 'config_order_status_id', '1', 0),
(3344, 0, 'config', 'config_invoice_prefix', 'INV-2012-00', 0),
(3343, 0, 'config', 'config_order_edit', '100', 0),
(3342, 0, 'config', 'config_checkout_id', '5', 0),
(3340, 0, 'config', 'config_cart_weight', '1', 0),
(3341, 0, 'config', 'config_guest_checkout', '1', 0),
(3339, 0, 'config', 'config_account_id', '3', 0),
(3338, 0, 'config', 'config_customer_price', '0', 0),
(3337, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(3336, 0, 'config', 'config_customer_group_id', '1', 0),
(3335, 0, 'config', 'config_customer_online', '0', 0),
(3334, 0, 'config', 'config_tax_customer', 'shipping', 0),
(3333, 0, 'config', 'config_tax_default', 'shipping', 0),
(3331, 0, 'config', 'config_tax', '1', 0),
(3332, 0, 'config', 'config_vat', '0', 0),
(3330, 0, 'config', 'config_voucher_max', '1000', 0),
(3329, 0, 'config', 'config_voucher_min', '1', 0),
(3328, 0, 'config', 'config_display_mpn', '0', 0),
(3325, 0, 'config', 'config_display_ean', '0', 0),
(3327, 0, 'config', 'config_display_isbn', '0', 0),
(3326, 0, 'config', 'config_display_jan', '0', 0),
(3324, 0, 'config', 'config_display_upc', '0', 0),
(3323, 0, 'config', 'config_display_sku', '0', 0),
(3322, 0, 'config', 'config_display_location', '0', 0),
(3321, 0, 'config', 'config_display_weight', '0', 0),
(3320, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(3319, 0, 'config', 'config_download', '1', 0),
(3317, 0, 'config', 'config_admin_limit', '20', 0),
(3318, 0, 'config', 'config_review_status', '1', 0),
(3316, 0, 'config', 'config_catalog_limit', '15', 0),
(3315, 0, 'config', 'config_product_count', '0', 0),
(3314, 0, 'config', 'config_main_menu', '0', 0),
(3313, 0, 'config', 'config_weight_class_id', '1', 0),
(3312, 0, 'config', 'config_length_class_id', '1', 0),
(3311, 0, 'config', 'config_currency_auto', '1', 0),
(3310, 0, 'config', 'config_currency', 'USD', 0),
(3309, 0, 'config', 'config_admin_language', 'ru', 0),
(3302, 0, 'config', 'config_meta_description', 'Интернет магазин', 0),
(3303, 0, 'config', 'config_meta_keyword', '', 0),
(3304, 0, 'config', 'config_template', 'oppo_template', 0),
(3305, 0, 'config', 'config_layout_id', '4', 0),
(3306, 0, 'config', 'config_country_id', '176', 0),
(3307, 0, 'config', 'config_zone_id', '2761', 0),
(3308, 0, 'config', 'config_language', 'ru', 0),
(3301, 0, 'config', 'config_title', 'Интернет магазин', 0),
(3299, 0, 'config', 'config_fax', '', 0),
(3300, 0, 'config', 'config_display_fax', '0', 0),
(3298, 0, 'config', 'config_display_telephone', '1', 0),
(3297, 0, 'config', 'config_telephone', '8 900 800 5050', 0),
(3296, 0, 'config', 'config_display_email', '0', 0),
(3294, 0, 'config', 'config_display_address', '0', 0),
(3295, 0, 'config', 'config_email', 'bordyanartem@gmail.com', 0),
(3293, 0, 'config', 'config_address', 'Адрес', 0),
(3292, 0, 'config', 'config_owner', 'Мое Имя', 0),
...
(3291, 0, 'config', 'config_name', 'Интернет магазин', 0);
