...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 07 2013 г., 04:18
...
(1, 1, 'sfdsd', 'fsdfsd', '', '', '', '   gfdgfdgdf', '', '   gdfgfdgfdgdf', '23323', 220, 0);
...
CREATE TABLE IF NOT EXISTS `oc_affiliate` (
  ...
  `webmoney_wmr` varchar(64) NOT NULL DEFAULT '',
  `webmoney_wmz` varchar(64) NOT NULL DEFAULT '',
  `webmoney_wme` varchar(64) NOT NULL DEFAULT '',
  `webmoney_wmu` varchar(64) NOT NULL DEFAULT '',
  `yandex_money` varchar(64) NOT NULL DEFAULT '',
...
(78, 7, 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'data/demo/samsung_banner.jpg'),
...
(25, '', 0, 1, 1, 3, 1, '2009-01-31 01:04:25', '2013-10-05 18:40:47'),
(27, '', 20, 0, 0, 2, 0, '2009-01-31 01:55:34', '2013-10-05 20:38:58'),
(20, 'data/compaq_presario.jpg', 0, 1, 1, 1, 1, '2009-01-05 21:49:43', '2013-12-06 18:32:20'),
(18, 'data/hp_2.jpg', 0, 1, 0, 2, 1, '2009-01-05 21:49:15', '2013-10-05 18:40:27'),
(26, '', 20, 0, 0, 1, 0, '2009-01-31 01:55:14', '2013-10-05 20:38:48'),
(34, 'data/ipod_touch_4.jpg', 0, 1, 4, 7, 1, '2009-02-03 14:18:11', '2013-10-05 18:41:01'),
(45, '', 18, 0, 0, 0, 0, '2010-09-24 18:29:16', '2013-10-05 20:39:31'),
(46, '', 18, 0, 0, 0, 0, '2010-09-24 18:29:31', '2013-10-05 20:39:20');
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 32.78300095, 1, '2013-12-06 17:51:42'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2013-12-07 02:37:48'),
(3, 'Euro', 'EUR', '', '€', '2', 0.73130000, 1, '2013-12-06 17:51:42');
...
(1, 0, 'sfdsd', 'fsdfsd', 'bzduha@ukr.net', '2432432432', '', 'e10adc3949ba59abbe56e057f20f883e', '', 'a:2:{s:31:"40:YToxOntpOjIyNztzOjI6IjE3Ijt9";i:2;s:31:"30:YToxOntpOjIyNjtzOjI6IjE1Ijt9";i:1;}', '', 0, 1, 1, '127.0.0.1', 1, 1, '', '2013-10-29 21:40:39');
...
CREATE TABLE IF NOT EXISTS `oc_customer_group` (
  ...
  `telephone_display` int(1) NOT NULL,
  `fax_display` int(1) NOT NULL,
  `address_display` int(1) NOT NULL,
  `company_display` int(1) NOT NULL,
  `company_id_display` int(1) NOT NULL,
  `company_id_required` int(1) NOT NULL,
  `tax_id_display` int(1) NOT NULL,
  `tax_id_required` int(1) NOT NULL,
  `address_2_display` int(1) NOT NULL,
  `additional_display` int(1) NOT NULL,
  `sort_order` int(3) NOT NULL,
...
INSERT INTO `oc_customer_group` (`customer_group_id`, `approval`, `telephone_display`, `fax_display`, `address_display`, `company_display`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `address_2_display`, `additional_display`, `sort_order`) VALUES
...
(1, 1, '127.0.0.1', '2013-10-29 21:40:55');

-- --------------------------------------------------------

--
-- Структура таблицы `oc_customer_ip_blacklist`
--
...
--
-- Структура таблицы `oc_customer_support`
--

CREATE TABLE IF NOT EXISTS `oc_customer_support` (
  `customer_support_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_support_topic_id` int(11) DEFAULT NULL,
  `customer_support_status` varchar(50) DEFAULT NULL,
...
--
-- Структура таблицы `oc_customer_support_category`
--

CREATE TABLE IF NOT EXISTS `oc_customer_support_category` (
  `category_id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `sort_order` int(3) NOT NULL DEFAULT '0',
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Структура таблицы `oc_customer_support_category_description`
--

CREATE TABLE IF NOT EXISTS `oc_customer_support_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`category_id`,`language_id`),
...
--
-- Структура таблицы `oc_customer_support_category_to_store`
--

CREATE TABLE IF NOT EXISTS `oc_customer_support_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(433, 'module', 'we_menu'),
(434, 'module', 'news'),
(435, 'module', 'ncategory'),
(439, 'module', 'filterpro');
...
(32, 12, 0, 'news/headlines'),
(33, 13, 0, 'news/ncategory'),
(34, 14, 0, 'news/article'),
(36, 15, 0, 'product/filter'),
(38, 1, 0, 'common/home');
...
(10, '', 8, 0, NULL, NULL, NULL, '', '59', '1', 'category', 0, 1, 'menu', 0, 1, 0, 99, 0, '', NULL, 0, 'top', 'pav-menu-child', NULL, '', '', 0, 0, 0),
...
(59, '', 0, 0, 10, 0, 1, '2013-11-13 16:23:46', '2013-11-13 16:23:46');
...
INSERT INTO `oc_ncategory_description` (`ncategory_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`) VALUES
(59, 1, 'Новости', '', '', '', '', ''),
(59, 2, 'News', '', '', '', '', '');
...
INSERT INTO `oc_news` (`news_id`, `status`, `image`, `acom`, `date_added`, `sort_order`) VALUES
(8, 1, 'data/example2.jpg', 1, '2013-11-13 16:25:20', 1);
...
INSERT INTO `oc_news_description` (`news_id`, `language_id`, `title`, `description`, `meta_desc`, `meta_key`, `seo_title`, `seo_h1`) VALUES
(8, 1, 'Designer lounge chairs', '&lt;p&gt;\r\n	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;br /&gt;\r\n	&lt;br /&gt;\r\n	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;br /&gt;\r\n	&amp;nbsp;&lt;/p&gt;\r\n', '', '', '', ''),
(8, 2, 'DESIGNER LOUNGE CHAIRS', '&lt;p&gt;\r\n	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;br /&gt;\r\n	&lt;br /&gt;\r\n	Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;br /&gt;\r\n	&amp;nbsp;&lt;/p&gt;\r\n', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `oc_news_to_ncategory` (
  `news_id` int(11) NOT NULL,
  `ncategory_id` int(11) NOT NULL,
  `main_ncategory` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `oc_news_to_ncategory` (`news_id`, `ncategory_id`, `main_ncategory`) VALUES
(8, 59, 1);
...
(57, 15, 'data/colors/white.png', 0),
(56, 15, 'data/colors/red.png', 0),
(55, 14, 'no_image.jpg', 0),
(54, 14, 'no_image.jpg', 0),
(53, 14, 'no_image.jpg', 0),
(52, 14, 'no_image.jpg', 0),
(51, 14, 'no_image.jpg', 0),
(58, 15, 'data/colors/blackhole.png', 0),
(59, 15, 'data/colors/blue.png', 0),
(60, 15, 'data/colors/green.png', 0),
(61, 15, 'data/colors/tlen.png', 0);
...
(58, 1, 15, 'Черный'),
(56, 1, 15, 'Красный'),
(55, 1, 14, 'Кресло-мешок'),
(54, 2, 14, 'Трансформер'),
(57, 2, 15, 'Белый'),
(53, 1, 14, 'Диван'),
(57, 1, 15, 'Белый'),
(55, 2, 14, 'Кресло-мешок'),
(54, 1, 14, 'Трансформер'),
(53, 2, 14, 'Диван'),
(52, 2, 14, 'Стул'),
(52, 1, 14, 'Стул'),
...
CREATE TABLE IF NOT EXISTS `oc_order` (
  ...
  `ip` varchar(15) NOT NULL,
  `forwarded_ip` varchar(15) NOT NULL,
...
(28, 'Товар 1', '', '', '', '', '', '', '', 939, 7, 'data/demo/htc_touch_hd_1.jpg', 5, 1, '100.0000', 200, 0, '2009-02-03', '146.40000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 16:06:50', '2013-10-13 23:08:47', 1),
(29, 'Товар 2', '', '', '', '', '', '', '', 999, 6, 'data/demo/palm_treo_pro_1.jpg', 6, 1, '279.9900', 0, 0, '2009-02-03', '133.00000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 16:42:17', '2013-10-13 23:11:26', 0),
(30, 'Товар 3', '', '', '', '', '', '', '', 7, 6, 'data/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 0, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 16:59:00', '2013-12-07 01:54:12', 84),
(31, 'Товар 4', '', '', '', '', '', '', '', 1000, 6, 'data/demo/nikon_d300_1.jpg', 0, 1, '80.0000', 0, 0, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 17:00:10', '2013-10-13 23:11:03', 0),
(32, 'Товар 5', '', '', '', '', '', '', '', 999, 6, 'data/demo/ipod_touch_1.jpg', 8, 1, '100.0000', 0, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 17:07:26', '2013-10-13 23:10:32', 1),
(33, 'Товар 6', '', '', '', '', '', '', '', 1000, 6, 'data/demo/samsung_syncmaster_941bw.jpg', 0, 1, '200.0000', 0, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 17:08:31', '2013-10-13 23:11:37', 0),
(34, 'Товар 7', '', '', '', '', '', '', '', 1000, 6, 'data/demo/ipod_shuffle_1.jpg', 8, 1, '100.0000', 0, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 18:07:54', '2013-10-13 23:10:04', 0),
(35, 'Товар 8', '', '', '', '', '', '', '', 1000, 5, 'data/example2.jpg', 0, 0, '100.0000', 0, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 18:08:31', '2013-12-06 19:52:40', 1),
(36, 'Товар 9', '', '', '', '', '', '', '', 994, 6, 'data/demo/ipod_nano_1.jpg', 8, 0, '100.0000', 100, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 18:09:19', '2013-10-13 23:09:53', 1),
(40, 'Товар 11', '', '', '', '', '', '', '', 970, 5, 'data/demo/iphone_1.jpg', 8, 1, '101.0000', 0, 0, '2009-02-03', '10.00000000', 1, '30.00000000', '50.00000000', '60.00000000', 1, 1, 1, 0, 1, '2009-02-03 21:07:12', '2013-12-07 01:14:47', 364),
(41, 'Товар 14', '', '', '', '', '', '', '', 977, 5, 'data/demo/imac_1.jpg', 8, 1, '100.0000', 0, 0, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 21:07:26', '2013-10-13 23:09:03', 0),
(42, 'Товар 15', '', '', '', '', '', '', '', 990, 5, 'data/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 0, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 0, 0, 1, '2009-02-03 21:07:37', '2013-12-07 02:06:15', 65),
(43, 'Товар 16', '', '', '', '', '', '', '', 929, 5, 'data/demo/macbook_1.jpg', 8, 0, '500.0000', 0, 0, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:07:49', '2013-12-07 01:16:59', 0),
(44, 'Товар 17', '', '', '', '', '', '', '', 1000, 5, 'data/demo/macbook_air_1.jpg', 8, 1, '1000.0000', 0, 0, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:00', '2013-10-13 23:10:51', 0),
(45, 'Товар 18', '', '', '', '', '', '', '', 998, 5, 'data/demo/macbook_pro_1.jpg', 8, 1, '2000.0000', 0, 100, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:17', '2011-09-15 22:22:01', 1),
(46, 'Товар 19', '', '', '', '', '', '', '', 1000, 5, 'data/demo/sony_vaio_1.jpg', 10, 1, '1000.0000', 0, 0, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:29', '2013-12-06 19:53:31', 51),
(47, 'Товар 21', '', '', '', '', '', '', '', 1000, 5, 'data/demo/hp_1.jpg', 7, 1, '100.0000', 400, 0, '2009-02-03', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, '2009-02-03 21:08:40', '2013-12-07 01:14:30', 19),
(48, 'Товар 20', 'test 1', '', '', '', '', '', 'test 2', 995, 5, 'data/demo/ipod_classic_1.jpg', 8, 1, '100.0000', 0, 0, '2009-02-08', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-08 17:21:51', '2013-10-13 23:09:42', 0),
(49, 'SAM1', '', '', '', '', '', '', '', 2, 8, 'data/demo/samsung_tab_1.jpg', 0, 1, '199.9900', 0, 0, '2011-04-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2013-12-06 19:54:21', 7);
...
INSERT INTO `oc_product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `short_description`, `seo_title`, `seo_h1`, `tag`) VALUES
...
(506, 42, 1, 30, 1, '66.0000', '0000-00-00', '0000-00-00'),
(505, 42, 1, 20, 1, '77.0000', '0000-00-00', '0000-00-00'),
(504, 42, 1, 10, 1, '88.0000', '0000-00-00', '0000-00-00');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2638 ;
...
(2617, 30, 'data/demo/canon_eos_5d_2.jpg', 0),
(2560, 47, 'data/demo/hp_2.jpg', 0),
(2367, 28, 'data/demo/htc_touch_hd_3.jpg', 0),
(2369, 41, 'data/demo/imac_2.jpg', 0),
(2565, 40, 'data/demo/iphone_4.jpg', 0),
(2384, 36, 'data/demo/ipod_nano_3.jpg', 0),
(2383, 36, 'data/demo/ipod_nano_2.jpg', 0),
(2388, 34, 'data/demo/ipod_shuffle_3.jpg', 0),
(2387, 34, 'data/demo/ipod_shuffle_2.jpg', 0),
(2394, 32, 'data/demo/ipod_touch_4.jpg', 0),
(2393, 32, 'data/demo/ipod_touch_3.jpg', 0),
(2392, 32, 'data/demo/ipod_touch_2.jpg', 0),
(2569, 43, 'data/demo/macbook_5.jpg', 0),
(2568, 43, 'data/demo/macbook_4.jpg', 0),
(2401, 44, 'data/demo/macbook_air_3.jpg', 0),
(2400, 44, 'data/demo/macbook_air_2.jpg', 0),
(1977, 45, 'data/demo/macbook_pro_2.jpg', 0),
(1976, 45, 'data/demo/macbook_pro_3.jpg', 0),
(2405, 31, 'data/demo/nikon_d300_5.jpg', 0),
(2404, 31, 'data/demo/nikon_d300_4.jpg', 0),
(2407, 29, 'data/demo/palm_treo_pro_2.jpg', 0),
(2380, 48, 'data/demo/ipod_classic_4.jpg', 0),
(2379, 48, 'data/demo/ipod_classic_3.jpg', 0),
(2564, 40, 'data/demo/iphone_3.jpg', 0),
(2563, 40, 'data/demo/iphone_5.jpg', 0),
(2616, 30, 'data/demo/canon_eos_5d_3.jpg', 0),
(2559, 47, 'data/demo/hp_3.jpg', 0),
(2366, 28, 'data/demo/htc_touch_hd_2.jpg', 0),
(2368, 41, 'data/demo/imac_3.jpg', 0),
(2562, 40, 'data/demo/iphone_2.jpg', 0),
(2561, 40, 'data/demo/iphone_6.jpg', 0),
(2378, 48, 'data/demo/ipod_classic_2.jpg', 0),
(2382, 36, 'data/demo/ipod_nano_4.jpg', 0),
(2381, 36, 'data/demo/ipod_nano_5.jpg', 0),
(2386, 34, 'data/demo/ipod_shuffle_4.jpg', 0),
(2385, 34, 'data/demo/ipod_shuffle_5.jpg', 0),
(2391, 32, 'data/demo/ipod_touch_5.jpg', 0),
(2390, 32, 'data/demo/ipod_touch_6.jpg', 0),
(2389, 32, 'data/demo/ipod_touch_7.jpg', 0),
(2567, 43, 'data/demo/macbook_2.jpg', 0),
(2566, 43, 'data/demo/macbook_3.jpg', 0),
(2399, 44, 'data/demo/macbook_air_4.jpg', 0),
(1975, 45, 'data/demo/macbook_pro_4.jpg', 0),
(2403, 31, 'data/demo/nikon_d300_2.jpg', 0),
(2402, 31, 'data/demo/nikon_d300_3.jpg', 0),
(2406, 29, 'data/demo/palm_treo_pro_3.jpg', 0),
(2511, 49, 'data/demo/samsung_tab_2.jpg', 0),
(2510, 49, 'data/demo/samsung_tab_3.jpg', 0),
(2509, 49, 'data/demo/samsung_tab_4.jpg', 0),
(2508, 49, 'data/demo/samsung_tab_5.jpg', 0),
(2507, 49, 'data/demo/samsung_tab_6.jpg', 0),
(2506, 49, 'data/demo/samsung_tab_7.jpg', 0),
(2637, 42, 'data/demo/hp_1.jpg', 0),
(2636, 42, 'data/demo/compaq_presario.jpg', 0),
(2635, 42, 'data/demo/canon_eos_5d_1.jpg', 0),
(2634, 42, 'data/demo/canon_eos_5d_2.jpg', 0),
(2633, 42, 'data/demo/canon_logo.jpg', 0);
...
(19, 228, 42, 15, 57, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(24, 228, 42, 15, 59, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(20, 228, 42, 15, 56, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(22, 230, 30, 15, 59, 5, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(27, 228, 42, 15, 58, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(23, 231, 30, 14, 53, 5, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(25, 228, 42, 15, 60, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(26, 228, 42, 15, 61, 8, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(21, 229, 42, 14, 52, 2, 1, '0.0000', '+', 0, '+', '0.00000000', '+');
...
(473, 42, 1, 1, '90.0000', '0000-00-00', '0000-00-00'),
(469, 30, 1, 2, '90.0000', '0000-00-00', '0000-00-00'),
(468, 30, 1, 1, '80.0000', '0000-00-00', '0000-00-00');
...
(1, 1, 'Возврат выполнен'),
(2, 1, 'Покупка в кредит'),
...
(3, 1, 'Ошибка при заказе'),
(4, 1, 'Данный товар уже не нужен'),
(5, 1, 'Другое'),
(1, 2, 'Dead On Arrival'),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5159 ;
...
(3808, 0, 'featured', 'product', '', 0),
(3809, 0, 'featured', 'featured_product', '43,40,42,49,46,47,28', 0),
(3810, 0, 'featured', 'featured_module', 'a:1:{i:0;a:7:{s:5:"limit";s:1:"6";s:11:"image_width";s:2:"80";s:12:"image_height";s:2:"80";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"2";}}', 1),
...
(3807, 0, 'slideshow', 'slideshow_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"7";s:5:"width";s:3:"980";s:6:"height";s:3:"280";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}}', 1),
(4895, 0, 'banner', 'banner_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"6";s:5:"width";s:3:"182";s:6:"height";s:3:"182";s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"3";}}', 1),
(5157, 0, 'filterpro', 'filterpro_setting', 'a:18:{s:12:"price_slider";s:1:"1";s:20:"display_manufacturer";s:8:"checkbox";s:18:"display_categories";s:8:"checkbox";s:12:"display_tags";s:8:"checkbox";s:17:"display_option_14";s:8:"checkbox";s:17:"display_option_15";s:5:"image";s:20:"display_attribute_15";s:8:"checkbox";s:14:"attr_delimeter";s:1:":";s:3:"tax";s:1:"0";s:11:"option_mode";s:2:"or";s:14:"attribute_mode";s:2:"or";s:10:"attr_group";s:1:"0";s:11:"sku_display";s:1:"0";s:13:"model_display";s:1:"0";s:13:"brand_display";s:1:"0";s:16:"location_display";s:1:"0";s:11:"upc_display";s:1:"0";s:13:"stock_display";s:1:"0";}', 1),
(5158, 0, 'filterpro', 'filterpro_module', 'a:2:{i:0;a:5:{s:4:"type";s:1:"0";s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}i:1;a:5:{s:4:"type";s:1:"0";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}}', 1),
(3156, 0, 'we_menu', 'we_menu_class', 'links', 0),
(3157, 0, 'we_menu', 'tpl_row', '&lt;li&gt;&lt;a href=&quot;#href#&quot; class=&quot;#class#&quot; #attributes#&gt;#title#&lt;/a&gt;&lt;/li&gt;', 0),
(3158, 0, 'we_menu', 'tpl_row_act', '&lt;li class=&quot;active&quot;&gt;#title#&lt;/li&gt;', 0),
(3159, 0, 'we_menu', 'we_menu', 'a:6:{i:0;a:7:{s:4:"item";s:14:"Магазин";s:9:"item_type";s:10:"clear_link";s:9:"item_link";s:1:"/";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"0";s:11:"item_enable";s:2:"on";}i:1;a:7:{s:4:"item";s:9:"О нас";s:9:"item_type";s:12:"article_link";s:9:"item_link";s:0:"";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"1";s:11:"item_enable";s:2:"on";}i:2;a:7:{s:4:"item";s:16:"Партнеры";s:9:"item_type";s:12:"article_link";s:9:"item_link";s:1:"4";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"2";s:11:"item_enable";s:2:"on";}i:3;a:7:{s:4:"item";s:28:"Акции и новости";s:9:"item_type";s:10:"clear_link";s:9:"item_link";s:30:"index.php?route=news/headlines";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"3";s:11:"item_enable";s:2:"on";}i:4;a:7:{s:4:"item";s:32:"Оплата и доставка";s:9:"item_type";s:12:"article_link";s:9:"item_link";s:1:"5";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"4";s:11:"item_enable";s:2:"on";}i:5;a:7:{s:4:"item";s:41:"Контактная информация";s:9:"item_type";s:12:"article_link";s:9:"item_link";s:0:"";s:5:"class";s:0:"";s:4:"attr";s:0:"";s:4:"sort";s:1:"5";s:11:"item_enable";s:2:"on";}}', 1),
(3160, 0, 'we_menu', 'we_menu_cache', 'a:6:{i:0;a:3:{s:7:"tpl_row";s:93:"&lt;li&gt;&lt;a href=&quot;/&quot; class=&quot;&quot; &gt;Магазин&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:60:"&lt;li class=&quot;active&quot;&gt;Магазин&lt;/li&gt;";s:4:"href";s:1:"/";}i:1;a:3:{s:7:"tpl_row";s:143:"&lt;li&gt;&lt;a href=&quot;/index.php?route=information/information&information_id=&quot; class=&quot;&quot; &gt;О нас&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:55:"&lt;li class=&quot;active&quot;&gt;О нас&lt;/li&gt;";s:4:"href";s:56:"/index.php?route=information/information&information_id=";}i:2;a:3:{s:7:"tpl_row";s:151:"&lt;li&gt;&lt;a href=&quot;/index.php?route=information/information&information_id=4&quot; class=&quot;&quot; &gt;Партнеры&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:62:"&lt;li class=&quot;active&quot;&gt;Партнеры&lt;/li&gt;";s:4:"href";s:57:"/index.php?route=information/information&information_id=4";}i:3;a:3:{s:7:"tpl_row";s:136:"&lt;li&gt;&lt;a href=&quot;index.php?route=news/headlines&quot; class=&quot;&quot; &gt;Акции и новости&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:74:"&lt;li class=&quot;active&quot;&gt;Акции и новости&lt;/li&gt;";s:4:"href";s:30:"index.php?route=news/headlines";}i:4;a:3:{s:7:"tpl_row";s:167:"&lt;li&gt;&lt;a href=&quot;/index.php?route=information/information&information_id=5&quot; class=&quot;&quot; &gt;Оплата и доставка&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:78:"&lt;li class=&quot;active&quot;&gt;Оплата и доставка&lt;/li&gt;";s:4:"href";s:57:"/index.php?route=information/information&information_id=5";}i:5;a:3:{s:7:"tpl_row";s:175:"&lt;li&gt;&lt;a href=&quot;/index.php?route=information/information&information_id=&quot; class=&quot;&quot; &gt;Контактная информация&lt;/a&gt;&lt;/li&gt;";s:11:"tpl_row_act";s:87:"&lt;li class=&quot;active&quot;&gt;Контактная информация&lt;/li&gt;";s:4:"href";s:56:"/index.php?route=information/information&information_id=";}}', 1),
(5156, 0, 'config', 'config_google_analytics', '', 0),
(5155, 0, 'config', 'config_error_filename', 'error.txt', 0),
(5154, 0, 'config', 'config_error_log', '1', 0),
(5153, 0, 'config', 'config_error_display', '1', 0),
(5152, 0, 'config', 'config_compression', '0', 0),
(5151, 0, 'config', 'config_encryption', '3892a7e8715a2557dfd848c5eadfa73a', 0),
(5150, 0, 'config', 'config_seo_url_postfix', '', 0),
(5149, 0, 'config', 'config_seo_url_include_path', '1', 0),
(5148, 0, 'config', 'config_seo_url_type', 'seo_pro', 0),
(5147, 0, 'config', 'config_seo_url', '1', 0),
(5146, 0, 'config', 'config_maintenance', '0', 0),
(5145, 0, 'config', 'config_use_ssl', '0', 0),
(5144, 0, 'config', 'config_symbols_nsearch', '300', 0),
(5143, 0, 'config', 'config_symbols_ncategory', '300', 0),
(5142, 0, 'config', 'config_symbols_headlines', '400', 0),
(5140, 0, 'config', 'config_mod_news', '370', 0),
(5141, 0, 'config', 'config_mod_news_side', '100', 0),
(5137, 0, 'config', 'config_bnews_thumb_width', '150', 0),
(5138, 0, 'config', 'config_bnews_thumb_height', '150', 0),
(5139, 0, 'config', 'config_bnews_order', '0', 0),
(5136, 0, 'config', 'config_bnews_image_height', '80', 0),
(5135, 0, 'config', 'config_bnews_image_width', '80', 0),
(5134, 0, 'config', 'config_image_ncategory_height', '80', 0),
(5133, 0, 'config', 'config_image_ncategory_width', '80', 0),
(3155, 0, 'news', 'news_popup_height', '500', 0),
(3154, 0, 'news', 'news_popup_width', '500', 0),
(3151, 0, 'news', 'news_headline_chars', '370', 0),
(3152, 0, 'news', 'news_thumb_width', '225', 0),
(3153, 0, 'news', 'news_thumb_height', '225', 0),
(3161, 0, 'ncategory', 'ncategory_module', 'a:1:{i:0;a:4:{s:9:"layout_id";s:1:"2";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:0:"";}}', 1),
(5132, 0, 'config', 'config_sms_gate_password', '', 0),
(5131, 0, 'config', 'config_sms_gate_username', '', 0),
(5129, 0, 'config', 'config_sms_copy', '', 0),
(5130, 0, 'config', 'config_sms_message', '', 0),
(5127, 0, 'config', 'config_sms_from', '', 0),
(5128, 0, 'config', 'config_sms_to', '', 0),
(5125, 0, 'config', 'config_sms_alert', '0', 0),
(5126, 0, 'config', 'config_sms_gatename', 'smsc', 0),
(5122, 0, 'config', 'config_fraud_key', '', 0),
(5123, 0, 'config', 'config_fraud_score', '', 0),
(5124, 0, 'config', 'config_fraud_status_id', '14', 0),
(5121, 0, 'config', 'config_fraud_detection', '0', 0),
(5120, 0, 'config', 'config_alert_emails', '', 0),
(5119, 0, 'config', 'config_account_mail', '0', 0),
(5118, 0, 'config', 'config_alert_mail', '0', 0),
(5117, 0, 'config', 'config_smtp_timeout', '5', 0),
(5116, 0, 'config', 'config_smtp_port', '25', 0),
(5115, 0, 'config', 'config_smtp_password', '', 0),
(5113, 0, 'config', 'config_smtp_host', '', 0),
(5114, 0, 'config', 'config_smtp_username', '', 0),
(5112, 0, 'config', 'config_mail_parameter', '', 0),
(5111, 0, 'config', 'config_mail_protocol', 'mail', 0),
(5110, 0, 'config', 'config_image_cart_height', '225', 0),
(5107, 0, 'config', 'config_image_wishlist_width', '47', 0),
(5109, 0, 'config', 'config_image_cart_width', '225', 0),
(5108, 0, 'config', 'config_image_wishlist_height', '47', 0),
(5106, 0, 'config', 'config_image_compare_height', '90', 0),
(5105, 0, 'config', 'config_image_compare_width', '90', 0),
(5104, 0, 'config', 'config_image_related_height', '85', 0),
(5096, 0, 'config', 'config_image_thumb_height', '480', 0),
(5097, 0, 'config', 'config_image_popup_width', '700', 0),
(5098, 0, 'config', 'config_image_popup_height', '700', 0),
(5099, 0, 'config', 'config_image_product_width', '225', 0),
(5100, 0, 'config', 'config_image_product_height', '225', 0),
(5101, 0, 'config', 'config_image_additional_width', '85', 0),
(5102, 0, 'config', 'config_image_additional_height', '85', 0),
(5103, 0, 'config', 'config_image_related_width', '85', 0),
(4894, 0, 'category', 'category_module', 'a:3:{i:0;a:5:{s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}i:1;a:5:{s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}i:2;a:5:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:5:"count";s:1:"0";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}}', 1),
(5095, 0, 'config', 'config_image_thumb_width', '480', 0),
(5093, 0, 'config', 'config_image_category_width', '130', 0),
(5094, 0, 'config', 'config_image_category_height', '130', 0),
(5092, 0, 'config', 'config_icon', 'data/cart.png', 0),
(5089, 0, 'config', 'config_commission', '5', 0),
(5090, 0, 'config', 'config_return_status_id', '2', 0),
(5091, 0, 'config', 'config_logo', 'data/logo.png', 0),
(5088, 0, 'config', 'config_affiliate_id', '4', 0),
(5087, 0, 'config', 'config_stock_status_id', '5', 0),
(5086, 0, 'config', 'config_stock_checkout', '0', 0),
(5085, 0, 'config', 'config_stock_warning', '0', 0),
(5084, 0, 'config', 'config_stock_display', '0', 0),
(5083, 0, 'config', 'config_complete_status_id', '5', 0),
(5082, 0, 'config', 'config_order_status_id', '1', 0),
(5081, 0, 'config', 'config_invoice_prefix', 'INV-2012-00', 0),
(5080, 0, 'config', 'config_order_edit', '100', 0),
(5079, 0, 'config', 'config_checkout_id', '5', 0),
(5078, 0, 'config', 'config_guest_checkout', '1', 0),
(5077, 0, 'config', 'config_cart_weight', '1', 0),
(5076, 0, 'config', 'config_account_id', '3', 0),
(5075, 0, 'config', 'config_customer_price', '0', 0),
(5074, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(5073, 0, 'config', 'config_customer_group_id', '1', 0),
(5072, 0, 'config', 'config_customer_online', '0', 0),
(5071, 0, 'config', 'config_tax_customer', 'shipping', 0),
(5070, 0, 'config', 'config_tax_default', 'shipping', 0),
(5069, 0, 'config', 'config_vat', '0', 0),
(5068, 0, 'config', 'config_tax', '1', 0),
(5067, 0, 'config', 'config_voucher_max', '1000', 0),
(5066, 0, 'config', 'config_voucher_min', '1', 0),
(5065, 0, 'config', 'config_display_mpn', '0', 0),
(5064, 0, 'config', 'config_display_isbn', '0', 0),
(5063, 0, 'config', 'config_display_jan', '0', 0),
(5062, 0, 'config', 'config_display_ean', '0', 0),
(5061, 0, 'config', 'config_display_upc', '0', 0),
(5060, 0, 'config', 'config_display_sku', '0', 0),
(5059, 0, 'config', 'config_display_location', '0', 0),
(5057, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(5058, 0, 'config', 'config_display_weight', '0', 0),
(5056, 0, 'config', 'config_download', '1', 0),
(5055, 0, 'config', 'config_review_status', '1', 0),
(5054, 0, 'config', 'config_admin_limit', '20', 0),
(5053, 0, 'config', 'config_catalog_limit', '15', 0),
(5052, 0, 'config', 'config_product_count', '0', 0),
(5051, 0, 'config', 'config_main_menu', '0', 0),
(5050, 0, 'config', 'config_weight_class_id', '1', 0),
(5049, 0, 'config', 'config_length_class_id', '1', 0),
(5048, 0, 'config', 'config_currency_auto', '1', 0),
(5047, 0, 'config', 'config_currency', 'USD', 0),
(5046, 0, 'config', 'config_admin_language', 'ru', 0),
(5045, 0, 'config', 'config_language', 'ru', 0),
(5044, 0, 'config', 'config_zone_id', '2761', 0),
(5043, 0, 'config', 'config_country_id', '176', 0),
(5042, 0, 'config', 'config_layout_id', '4', 0),
(5041, 0, 'config', 'config_template', 'oppo_template', 0),
(5040, 0, 'config', 'config_meta_keyword', '', 0),
(5038, 0, 'config', 'config_title', 'Интернет магазин', 0),
(5039, 0, 'config', 'config_meta_description', 'Интернет магазин', 0),
(5037, 0, 'config', 'config_display_fax', '0', 0),
(5036, 0, 'config', 'config_fax', '', 0),
(5035, 0, 'config', 'config_display_telephone', '1', 0),
(5034, 0, 'config', 'config_telephone', '8 900 800 5050', 0),
(5033, 0, 'config', 'config_display_email', '0', 0),
(5032, 0, 'config', 'config_email', 'bordyanartem@gmail.com', 0),
(5031, 0, 'config', 'config_display_address', '0', 0),
(5030, 0, 'config', 'config_address', 'Адрес', 0),
(5029, 0, 'config', 'config_owner', 'Мое Имя', 0),
(5028, 0, 'config', 'config_name', 'Интернет магазин', 0);
...
(86, 3, 'НДС (18%)', '0.0100', 'P', '2011-03-09 21:17:10', '2013-10-13 23:07:37'),
(87, 3, 'Eco Tax (-2.00)', '0.0000', 'F', '2011-09-21 21:49:23', '2013-10-13 23:07:23');
...
(832, 'product_id=48', 'ipod_classic'),
(828, 'category_id=26', 'pc'),
(829, 'category_id=27', 'mac'),
(781, 'manufacturer_id=8', 'apple'),
(777, 'information_id=4', 'about_us'),
(865, 'product_id=42', 'test'),
(826, 'category_id=34', 'mp3-players'),
(774, 'news/headlines', 'all-news'),
(782, 'common/home', ''),
(783, 'account/wishlist', 'wishlist'),
(784, 'account/account', 'account'),
(785, 'checkout/cart', 'shopping-cart'),
(786, 'checkout/checkout', 'checkout'),
(787, 'account/login', 'login'),
(788, 'account/logout', 'logout'),
(789, 'account/order', 'order-history'),
(790, 'account/newsletter', 'newsletter'),
(791, 'product/special', 'specials'),
(792, 'affiliate/account', 'affiliates'),
(793, 'checkout/voucher', 'gift-vouchers'),
(794, 'product/manufacturer', 'manufacturers'),
(795, 'information/contact', 'contact'),
(797, 'information/sitemap', 'sitemap'),
(798, 'account/forgotten', 'forgot-password'),
(799, 'account/download', 'downloads'),
(800, 'account/return', 'returns'),
(801, 'account/transaction', 'transaction'),
(802, 'account/register', 'register-account'),
(803, 'product/compare', 'compare-products'),
(804, 'product/search', 'search'),
(805, 'account/edit', 'edit-account'),
(806, 'account/password', 'change-password'),
(807, 'account/address', 'address-book'),
(808, 'account/reward', 'reward-points'),
(809, 'affiliate/edit', 'affiliate-edit-account'),
(810, 'affiliate/password', 'affiliate-change-password'),
(811, 'affiliate/payment', 'affiliate-payment-options'),
(812, 'affiliate/tracking', 'affiliate-tracking-code'),
(813, 'affiliate/transaction', 'affiliate-transactions'),
(814, 'affiliate/logout', 'affiliate-logout'),
(815, 'affiliate/forgotten', 'affiliate-forgot-password'),
(816, 'affiliate/register', 'affiliate-register-account'),
(817, 'affiliate/login', 'affiliate-login'),
(818, 'account/voucher', 'voucher'),
(819, 'account/customer_support', 'customer-support'),
(820, 'account/return/success', 'return-success'),
(821, 'checkout/success', 'checkout-success'),
(822, 'account/success', 'account-register-success'),
(823, 'affiliate/success', 'affiliate-register-success'),
(846, 'category_id=20', 'old-fashioned');
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', '', 'bordyanartem@gmail.com', '', '127.0.0.1', 1, '2013-09-28 17:52:29');
...
(1, 'Главный администратор', 'a:2:{s:6:"access";a:154:{i:0;s:17:"catalog/attribute";i:1;s:23:"catalog/attribute_group";i:2;s:16:"catalog/category";i:3;s:24:"catalog/customer_support";i:4;s:33:"catalog/customer_support_category";i:5;s:16:"catalog/download";i:6;s:14:"catalog/filter";i:7;s:20:"catalog/filter_group";i:8;s:19:"catalog/information";i:9;s:20:"catalog/manufacturer";i:10;s:17:"catalog/ncategory";i:11;s:17:"catalog/ncomments";i:12;s:12:"catalog/news";i:13;s:14:"catalog/option";i:14;s:15:"catalog/product";i:15;s:14:"catalog/review";i:16;s:31:"catalog/webme_additional_fields";i:17;s:18:"common/filemanager";i:18;s:16:"common/newspanel";i:19;s:13:"design/banner";i:20;s:13:"design/layout";i:21;s:14:"extension/feed";i:22;s:16:"extension/module";i:23;s:17:"extension/payment";i:24;s:18:"extension/shipping";i:25;s:15:"extension/total";i:26;s:25:"feed/articles_google_base";i:27;s:28:"feed/articles_google_sitemap";i:28;s:16:"feed/google_base";i:29;s:19:"feed/google_sitemap";i:30;s:18:"feed/yandex_market";i:31;s:20:"localisation/country";i:32;s:21:"localisation/currency";i:33;s:21:"localisation/geo_zone";i:34;s:21:"localisation/language";i:35;s:25:"localisation/length_class";i:36;s:25:"localisation/order_status";i:37;s:26:"localisation/return_action";i:38;s:26:"localisation/return_reason";i:39;s:26:"localisation/return_status";i:40;s:25:"localisation/stock_status";i:41;s:22:"localisation/tax_class";i:42;s:21:"localisation/tax_rate";i:43;s:25:"localisation/weight_class";i:44;s:17:"localisation/zone";i:45;s:14:"module/account";i:46;s:16:"module/affiliate";i:47;s:13:"module/banner";i:48;s:17:"module/bestseller";i:49;s:15:"module/carousel";i:50;s:15:"module/category";i:51;s:25:"module/category_superfish";i:52;s:15:"module/featured";i:53;s:13:"module/filter";i:54;s:18:"module/google_talk";i:55;s:18:"module/information";i:56;s:13:"module/latest";i:57;s:16:"module/ncategory";i:58;s:11:"module/news";i:59;s:18:"module/pavmegamenu";i:60;s:16:"module/slideshow";i:61;s:14:"module/special";i:62;s:12:"module/store";i:63;s:14:"module/topmenu";i:64;s:14:"module/we_menu";i:65;s:14:"module/welcome";i:66;s:16:"payment/alertpay";i:67;s:24:"payment/authorizenet_aim";i:68;s:21:"payment/bank_transfer";i:69;s:14:"payment/cheque";i:70;s:11:"payment/cod";i:71;s:21:"payment/free_checkout";i:72;s:14:"payment/liqpay";i:73;s:20:"payment/moneybookers";i:74;s:14:"payment/nochex";i:75;s:13:"payment/onpay";i:76;s:15:"payment/pay2pay";i:77;s:15:"payment/paymate";i:78;s:16:"payment/paypoint";i:79;s:26:"payment/perpetual_payments";i:80;s:14:"payment/pp_pro";i:81;s:17:"payment/pp_pro_uk";i:82;s:19:"payment/pp_standard";i:83;s:12:"payment/qiwi";i:84;s:17:"payment/robokassa";i:85;s:15:"payment/sagepay";i:86;s:22:"payment/sagepay_direct";i:87;s:18:"payment/sagepay_us";i:88;s:25:"payment/sberbank_transfer";i:89;s:19:"payment/twocheckout";i:90;s:28:"payment/web_payment_software";i:91;s:20:"payment/webmoney_wme";i:92;s:20:"payment/webmoney_wmr";i:93;s:20:"payment/webmoney_wmu";i:94;s:20:"payment/webmoney_wmz";i:95;s:16:"payment/worldpay";i:96;s:20:"payment/yandex_money";i:97;s:27:"report/affiliate_commission";i:98;s:22:"report/customer_credit";i:99;s:22:"report/customer_online";i:100;s:21:"report/customer_order";i:101;s:22:"report/customer_reward";i:102;s:24:"report/product_purchased";i:103;s:21:"report/product_viewed";i:104;s:18:"report/sale_coupon";i:105;s:17:"report/sale_order";i:106;s:18:"report/sale_return";i:107;s:20:"report/sale_shipping";i:108;s:15:"report/sale_tax";i:109;s:14:"sale/affiliate";i:110;s:12:"sale/contact";i:111;s:11:"sale/coupon";i:112;s:13:"sale/customer";i:113;s:23:"sale/customer_blacklist";i:114;s:19:"sale/customer_group";i:115;s:10:"sale/order";i:116;s:11:"sale/return";i:117;s:12:"sale/voucher";i:118;s:18:"sale/voucher_theme";i:119;s:15:"setting/setting";i:120;s:13:"setting/store";i:121;s:16:"shipping/auspost";i:122;s:17:"shipping/citylink";i:123;s:14:"shipping/fedex";i:124;s:13:"shipping/flat";i:125;s:13:"shipping/free";i:126;s:13:"shipping/item";i:127;s:23:"shipping/parcelforce_48";i:128;s:15:"shipping/pickup";i:129;s:19:"shipping/royal_mail";i:130;s:12:"shipping/ups";i:131;s:13:"shipping/usps";i:132;s:15:"shipping/weight";i:133;s:11:"tool/backup";i:134;s:14:"tool/error_log";i:135;s:12:"total/coupon";i:136;s:12:"total/credit";i:137;s:14:"total/handling";i:138;s:16:"total/klarna_fee";i:139;s:19:"total/low_order_fee";i:140;s:12:"total/reward";i:141;s:14:"total/shipping";i:142;s:15:"total/sub_total";i:143;s:9:"total/tax";i:144;s:11:"total/total";i:145;s:13:"total/voucher";i:146;s:9:"user/user";i:147;s:20:"user/user_permission";i:148;s:11:"module/news";i:149;s:16:"module/ncategory";i:150;s:35:"module/webme_categories_at_homepage";i:151;s:19:"module/categorywall";i:152;s:16:"module/filterpro";i:153;s:16:"module/filterpro";}s:6:"modify";a:154:{i:0;s:17:"catalog/attribute";i:1;s:23:"catalog/attribute_group";i:2;s:16:"catalog/category";i:3;s:24:"catalog/customer_support";i:4;s:33:"catalog/customer_support_category";i:5;s:16:"catalog/download";i:6;s:14:"catalog/filter";i:7;s:20:"catalog/filter_group";i:8;s:19:"catalog/information";i:9;s:20:"catalog/manufacturer";i:10;s:17:"catalog/ncategory";i:11;s:17:"catalog/ncomments";i:12;s:12:"catalog/news";i:13;s:14:"catalog/option";i:14;s:15:"catalog/product";i:15;s:14:"catalog/review";i:16;s:31:"catalog/webme_additional_fields";i:17;s:18:"common/filemanager";i:18;s:16:"common/newspanel";i:19;s:13:"design/banner";i:20;s:13:"design/layout";i:21;s:14:"extension/feed";i:22;s:16:"extension/module";i:23;s:17:"extension/payment";i:24;s:18:"extension/shipping";i:25;s:15:"extension/total";i:26;s:25:"feed/articles_google_base";i:27;s:28:"feed/articles_google_sitemap";i:28;s:16:"feed/google_base";i:29;s:19:"feed/google_sitemap";i:30;s:18:"feed/yandex_market";i:31;s:20:"localisation/country";i:32;s:21:"localisation/currency";i:33;s:21:"localisation/geo_zone";i:34;s:21:"localisation/language";i:35;s:25:"localisation/length_class";i:36;s:25:"localisation/order_status";i:37;s:26:"localisation/return_action";i:38;s:26:"localisation/return_reason";i:39;s:26:"localisation/return_status";i:40;s:25:"localisation/stock_status";i:41;s:22:"localisation/tax_class";i:42;s:21:"localisation/tax_rate";i:43;s:25:"localisation/weight_class";i:44;s:17:"localisation/zone";i:45;s:14:"module/account";i:46;s:16:"module/affiliate";i:47;s:13:"module/banner";i:48;s:17:"module/bestseller";i:49;s:15:"module/carousel";i:50;s:15:"module/category";i:51;s:25:"module/category_superfish";i:52;s:15:"module/featured";i:53;s:13:"module/filter";i:54;s:18:"module/google_talk";i:55;s:18:"module/information";i:56;s:13:"module/latest";i:57;s:16:"module/ncategory";i:58;s:11:"module/news";i:59;s:18:"module/pavmegamenu";i:60;s:16:"module/slideshow";i:61;s:14:"module/special";i:62;s:12:"module/store";i:63;s:14:"module/topmenu";i:64;s:14:"module/we_menu";i:65;s:14:"module/welcome";i:66;s:16:"payment/alertpay";i:67;s:24:"payment/authorizenet_aim";i:68;s:21:"payment/bank_transfer";i:69;s:14:"payment/cheque";i:70;s:11:"payment/cod";i:71;s:21:"payment/free_checkout";i:72;s:14:"payment/liqpay";i:73;s:20:"payment/moneybookers";i:74;s:14:"payment/nochex";i:75;s:13:"payment/onpay";i:76;s:15:"payment/pay2pay";i:77;s:15:"payment/paymate";i:78;s:16:"payment/paypoint";i:79;s:26:"payment/perpetual_payments";i:80;s:14:"payment/pp_pro";i:81;s:17:"payment/pp_pro_uk";i:82;s:19:"payment/pp_standard";i:83;s:12:"payment/qiwi";i:84;s:17:"payment/robokassa";i:85;s:15:"payment/sagepay";i:86;s:22:"payment/sagepay_direct";i:87;s:18:"payment/sagepay_us";i:88;s:25:"payment/sberbank_transfer";i:89;s:19:"payment/twocheckout";i:90;s:28:"payment/web_payment_software";i:91;s:20:"payment/webmoney_wme";i:92;s:20:"payment/webmoney_wmr";i:93;s:20:"payment/webmoney_wmu";i:94;s:20:"payment/webmoney_wmz";i:95;s:16:"payment/worldpay";i:96;s:20:"payment/yandex_money";i:97;s:27:"report/affiliate_commission";i:98;s:22:"report/customer_credit";i:99;s:22:"report/customer_online";i:100;s:21:"report/customer_order";i:101;s:22:"report/customer_reward";i:102;s:24:"report/product_purchased";i:103;s:21:"report/product_viewed";i:104;s:18:"report/sale_coupon";i:105;s:17:"report/sale_order";i:106;s:18:"report/sale_return";i:107;s:20:"report/sale_shipping";i:108;s:15:"report/sale_tax";i:109;s:14:"sale/affiliate";i:110;s:12:"sale/contact";i:111;s:11:"sale/coupon";i:112;s:13:"sale/customer";i:113;s:23:"sale/customer_blacklist";i:114;s:19:"sale/customer_group";i:115;s:10:"sale/order";i:116;s:11:"sale/return";i:117;s:12:"sale/voucher";i:118;s:18:"sale/voucher_theme";i:119;s:15:"setting/setting";i:120;s:13:"setting/store";i:121;s:16:"shipping/auspost";i:122;s:17:"shipping/citylink";i:123;s:14:"shipping/fedex";i:124;s:13:"shipping/flat";i:125;s:13:"shipping/free";i:126;s:13:"shipping/item";i:127;s:23:"shipping/parcelforce_48";i:128;s:15:"shipping/pickup";i:129;s:19:"shipping/royal_mail";i:130;s:12:"shipping/ups";i:131;s:13:"shipping/usps";i:132;s:15:"shipping/weight";i:133;s:11:"tool/backup";i:134;s:14:"tool/error_log";i:135;s:12:"total/coupon";i:136;s:12:"total/credit";i:137;s:14:"total/handling";i:138;s:16:"total/klarna_fee";i:139;s:19:"total/low_order_fee";i:140;s:12:"total/reward";i:141;s:14:"total/shipping";i:142;s:15:"total/sub_total";i:143;s:9:"total/tax";i:144;s:11:"total/total";i:145;s:13:"total/voucher";i:146;s:9:"user/user";i:147;s:20:"user/user_permission";i:148;s:11:"module/news";i:149;s:16:"module/ncategory";i:150;s:35:"module/webme_categories_at_homepage";i:151;s:19:"module/categorywall";i:152;s:16:"module/filterpro";i:153;s:16:"module/filterpro";}}'),
(10, 'Демонстрация', '');
...
--
-- Структура таблицы `oc_w_additional_fields`
--

CREATE TABLE IF NOT EXISTS `oc_w_additional_fields` (
...
--
-- Дамп данных таблицы `oc_w_additional_fields`
--

INSERT INTO `oc_w_additional_fields` (`field_id`, `field_name`, `field_value`, `product_id`, `status`, `date_added`) VALUES
(1, 'Высота', '60см', 40, '1', '0000-00-00 00:00:00'),
(2, 'Длина', '30см', 40, '1', '0000-00-00 00:00:00'),
(3, 'Ширина', '50см', 40, '1', '0000-00-00 00:00:00');
...
(3486, 220, 'IV', 'Ивано-Франковск''k', 1),
(3487, 220, 'KH', 'Харьков', 1),
(3488, 220, 'KM', 'Хмельницкий''nyts''kyy', 1),
(3489, 220, 'KR', 'Кировоград', 1),
(3490, 220, 'KV', 'Киевская область', 1),
(3491, 220, 'KY', 'Киев', 1),
(3492, 220, 'LU', 'Луганск''k', 1),
(3493, 220, 'LV', 'Львов', 1),
...
(65, 176, 0, 4, '2010-12-15 15:18:13', '0000-00-00 00:00:00');
